...
class Cortar_Texto
{
     ...
     * @return type
     */
    public static function cortar($texto = "texto", $max_total_letras = 40)
    {
        self::$texto = $texto;
